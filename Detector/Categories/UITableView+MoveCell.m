...
//            [self reloadData];
        ...
        case UIGestureRecognizerStateEnded:{
            ...
            if (self.moveCompleteBlock) {
                self.moveCompleteBlock(self.fromIndexPath, self.toIndexPath);
            }
            dispatch_async(dispatch_get_main_queue(), ^{
                self.moveCell  = [self cellForRowAtIndexPath:self.indexPath];
...
- (MoveCompleteBlock)moveCompleteBlock {
    return objc_getAssociatedObject(self, "moveCompleteBlock");
}

- (void)setMoveCompleteBlock:(MoveCompleteBlock)moveCompleteBlock {
    objc_setAssociatedObject(self, "moveCompleteBlock", moveCompleteBlock, OBJC_ASSOCIATION_COPY_NONATOMIC);
}
...
- (void)setFromIndexPath:(NSIndexPath *)fromIndexPath {
    objc_setAssociatedObject(self, "fromIndexPath", fromIndexPath, OBJC_ASSOCIATION_COPY_NONATOMIC);
}
...
- (void)setToIndexPath:(NSIndexPath *)toIndexPath {
    objc_setAssociatedObject(self, "toIndexPath", toIndexPath, OBJC_ASSOCIATION_COPY_NONATOMIC);
}
