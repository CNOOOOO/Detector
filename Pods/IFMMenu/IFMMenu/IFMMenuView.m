    ...
    for (IFMMenuItem *menuItem in _menuItems) {
       ...
       //自定义样式
        ...
        if (_menuItems.count == 1) {
            UIBezierPath * maskPath = [UIBezierPath bezierPathWithRoundedRect:button.layer.bounds byRoundingCorners:UIRectCornerAllCorners cornerRadii:CGSizeMake(_menu.menuCornerRadiu, _menu.menuCornerRadiu)];
